...
function OAuth2Strategy(options, verify) {
  ...
  if (!verify) { throw new TypeError('OpenknowlStrategy requires a verify callback'); }
  if (!options.clientID) { throw new TypeError('OpenknowlStrategy requires a clientID option'); }
  if (!options.clientSecret) { throw new TypeError('OpenknowlStrategy requires a clientSecret option'); }
  if (!options.profileURL) { throw new TypeError('OpenknowlStrategy requires a profileURL option'); }
  if (!options.tokenURL) { throw new TypeError('OpenknowlStrategy requires a tokenURL option'); }
  if (!options.authorizationURL) { throw new TypeError('OpenknowlStrategy requires a authorizationURL option'); }
  ...
  // modify here
  this.name = 'openknowl';
  this.profileUrl = options.profileURL || 'http://ac-dev.openknowl.com/api/me';
  options.authorizationURL = options.authorizationURL || 'http://ac-dev.openknowl.com/api/token';
  options.tokenURL = options.tokenURL || 'http://ac-dev.openknowl.com/api/token';
