...
function OAuth2Strategy(options, verify) {
  ...
  // modify here
  this.name = 'openknowl';
  this.profileUrl = 'https://ac-dev.openknowl.com/api/me';
  options.authorizationURL = 'https://ac-dev.openknowl.com/api/token';
  options.tokenURL = 'https://ac-dev.openknowl.com/api/token';

  // NOTE: The _oauth2 property is considered "protected".  Subclasses are
  //       allowed to use it when making protected resource requests to retrieve
  //       the user profile.
  this._oauth2 = new OAuth2(options.clientID,  options.clientSecret,
      '', this.authorizationURL, this.tokenURL, options.customHeaders);
...
=======
  // modify here
>>>>>>> a65dbc695035c9421dfea0da27655addeab57184
